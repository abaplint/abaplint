...
const tests = [
  ...
  `MODIFY CURRENT LINE LINE FORMAT COLOR COL_NORMAL RESET FIELD FORMAT fmt COLOR COL_KEY.`,
  `MODIFY CURRENT LINE LINE FORMAT INPUT OFF INVERSE RESET INTENSIFIED.`,
  ...
  `MODIFY CURRENT LINE FIELD FORMAT icon_4 HOTSPOT ON.`,
  `MODIFY LINE sdf FIELD FORMAT sdf INPUT.`,
];
