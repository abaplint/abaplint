...
const tests = [
  ...
  "CLASS-METHODS m1 IMPORTING !REFERENCE(iv_x) TYPE i.",
  "CLASS-METHODS m1 IMPORTING !value(iv_x) TYPE i EXPORTING !value(ev_y) TYPE i.",
  "METHODS m1 RETURNING !VALUE(rv_x) TYPE i.",
  "METHODS m1 RETURNING !value(rv_x) TYPE i.",
