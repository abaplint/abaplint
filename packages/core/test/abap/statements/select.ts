...
const versions = [
  {abap: "SELECT field, uuid( ) AS uuid FROM table INTO TABLE @DATA(result).", rel: Release.v754},
  {abap: "SELECT SINGLE abs( field ) FROM ztable INTO @DATA(sdfsd).", rel: Release.v740sp05},
  {abap: `SELECT FROM ztable
    ...
    CASE status
      ...
      ELSE '3'
    END
  INTO TABLE @DATA(sdfsd).`, rel: Release.v750},
  {abap: `SELECT field1, field2, division( 0, 1, 2 ) AS r1, division( 100, 2, 2 ) AS r2, division( -100, 5, 0 ) AS r3 FROM ztable INTO TABLE @DATA(result).`, rel: Release.v751},
  {abap: `SELECT field1, division( field2, 2, 2 ) AS r1, division( field2, -5, 1 ) AS r2 FROM ztable INTO TABLE @DATA(result).`, rel: Release.v751},
  {abap: `SELECT field1, division( 100, field2, 2 ) AS r1 FROM ztable WHERE field3 = @lv_val INTO TABLE @DATA(result).`, rel: Release.v751},
  {abap: `SELECT t1~field1, t1~field2, division( t1~field3, t2~field3, 2 ) AS ratio FROM ztable AS t1 INNER JOIN ztable2 AS t2 ON t1~field1 = t2~field1 ORDER BY t1~field1 INTO TABLE @DATA(result).`, rel: Release.v751},
  {abap: `SELECT t1~field1, division( t1~field2, t2~field2, 2 ) AS d FROM ztable AS t1 LEFT OUTER JOIN ztable2 AS t2 ON t1~field1 = t2~field1 WHERE division( t1~field2, t2~field2, 2 ) IS NOT NULL INTO TABLE @DATA(result).`, rel: Release.v751},
  {abap: `SELECT t1~field1, division( t1~field2, t2~field2, 2 ) AS d FROM ztable AS t1 LEFT OUTER JOIN ztable2 AS t2 ON t1~field1 = t2~field1 WHERE division( t1~field2, t2~field2, 2 ) IS NULL INTO TABLE @DATA(result).`, rel: Release.v751},
  {abap: `SELECT col FROM ztab USING CLIENT @lv_mandt INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT col FROM ztab ORDER BY col INTO TABLE @DATA(lt_r) UP TO 10 ROWS OFFSET @lv_off.`, rel: Release.v751},
  {abap: `SELECT col1 + col2 AS first , COUNT(*) AS second FROM ztab GROUP BY col1 + col2 ORDER BY first INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT - col AS neg , COUNT(*) AS cnt FROM ztab GROUP BY - col INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT CASE WHEN col = 0 THEN 0 WHEN col IS NOT NULL THEN 1 END AS grp , COUNT(*) FROM ztab GROUP BY CASE WHEN col = 0 THEN 0 WHEN col IS NOT NULL THEN 1 END INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT 1 + CASE WHEN col < 2 THEN 1 END AS grp , COUNT(*) FROM ztab GROUP BY 1 + CASE WHEN col < 2 THEN 1 END INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT col FROM ztab GROUP BY REPLACE( CONCAT( col , col2 ) , col3 , col4 ) INTO TABLE @DATA(lt_r).`, rel: Release.v750},
  {abap: `SELECT col1 + col2 AS first , col3 , COUNT(*) AS cnt FROM ztab GROUP BY col1 + col2 , col3 INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT - col AS neg , col2 , COUNT(*) AS cnt FROM ztab GROUP BY - col , col2 INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT @lv_const AS c , col , COUNT(*) AS cnt FROM ztab GROUP BY @lv_const , col INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
];

statementVersion(versions, "SELECT", Statements.Select);

statementVersionOk([
  {abap: `SELECT * FROM ztab1 \\_assoc1 AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v740sp05},
  {abap: `SELECT * FROM ztab1\\_assoc1 AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v740sp05},
  {abap: `SELECT * FROM ztab1 \\_assoc1 \\_assoc2 AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v740sp05},
  {abap: `SELECT * FROM ztab1( col1 = 'AB', col2 = 3 ) \\_assoc1 AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1( col1 = 'AB', col2 = 3 ) AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1\\_assoc1( col1 = 'AB', col2 = 3 ) AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ col4 = @sy-uname ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ WHERE col4 = @sy-uname ] AS r INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ INNER ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ LEFT OUTER ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ RIGHT OUTER ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ ONE TO ONE ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ MANY TO ONE ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ ONE TO MANY ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ MANY TO MANY ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ EXACT ONE TO ONE ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ INNER WHERE col4 = @sy-uname ] AS r INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1[ LEFT OUTER WHERE col4 = @sy-uname ] AS r INTO TABLE @result.`, rel: Release.v751},
  ...
  {abap: `SELECT * FROM ztab1( col1 = 'AB', col2 = 3 ) \\_assoc1( col1 = 'CD', col2 = 3 )[ key1 < 3 ] \\_assoc2( col1 = @lv_qr, col2 = 2 ) AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1-col FROM ztab1 INTO TABLE @r.`, rel: Release.v740sp05},
  {abap: `SELECT t1~\\_assoc1-col FROM ztab1 AS t1 INTO TABLE @r.`, rel: Release.v740sp05},
  {abap: `SELECT \\_assoc1\\_assoc2-col FROM ztab1 INTO TABLE @r.`, rel: Release.v740sp05},
  {abap: `SELECT \\_assoc1-col AS c FROM ztab1 INTO TABLE @r.`, rel: Release.v740sp05},
  {abap: `SELECT \\_assoc1[ key1 < 3 ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1[ WHERE key1 < 3 ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1[ INNER ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1[ LEFT OUTER ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1[ ONE TO ONE ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1[ MANY TO ONE ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1[ INNER WHERE key1 < 3 ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1[ LEFT OUTER WHERE key1 < 3 ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1[ ONE TO ONE WHERE key1 < 3 ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT \\_assoc1( col1 = 'AB' )[ key1 < 3 ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT t1~\\_assoc1\\_assoc2-col FROM ztab1 AS t1 INTO TABLE @r.`, rel: Release.v740sp05},
  {abap: `SELECT /foo/t1~\\_assoc-col FROM /foo/ztab AS /foo/t1 INTO TABLE @r.`, rel: Release.v740sp05},
  {abap: `SELECT /foo/t1~\\_assoc[ key1 < 3 ]-col FROM /foo/ztab AS /foo/t1 INTO TABLE @r.`, rel: Release.v751},
  {abap: `SELECT t1~key1 AS k1 FROM ztab1 AS t1 WHERE t1~col4 = @sy-uname AND key1 = ( SELECT key1 FROM ztab1 AS t2 WHERE t1~\\_assoc1-key1 = t2~key1 ) INTO TABLE @lt_result.`, rel: Release.v750},
  {abap: `SELECT count(*) AS cnt FROM ztab1 AS t1 WHERE key1 < 8877 GROUP BY t1~\\_assoc1-key1 HAVING count(*) > 0 INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT gla, \\_skat-txt50, indi FROM /foo/bar WHERE indi = @abap_false AND \\_skat-spras = @sy-langu ORDER BY gla ASCENDING INTO TABLE @lt.`, rel: Release.v740sp05},
  {abap: `SELECT FROM zcds FIELDS col1, \\_Text[ ONE TO ONE WHERE Language = @sy-langu ]-LanguageName ORDER BY col1 INTO TABLE @DATA(languages).`, rel: Release.v751},
  {abap: `SELECT FROM /foo/bar FIELDS (mv_sql_select) WHERE uuid = @mv__uuid AND \\_foo\\_bar-top IN @mt_top GROUP BY (mv_sql_group) INTO CORRESPONDING FIELDS OF TABLE @mt_result.`, rel: Release.v750},
], "SELECT association path expressions", Statements.Select);

statementVersionFail([
  {abap: `SELECT * FROM ztab1 \\_assoc1 ( col1 = 'AB' ) AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1\\_assoc1 ( col1 = 'AB' ) AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1( col1 = 'AB' ) \\_assoc1 ( col2 = @lv ) AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1 [ col4 = @sy-uname ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1\\_assoc1 [ col4 = @sy-uname ] AS r WHERE col4 = @sy-uname INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT * FROM ztab1 \\_assoc1( col1 = 'AB' ) [ col4 = @sy-uname ] AS r INTO TABLE @result.`, rel: Release.v751},
  {abap: `SELECT t1~key1 FROM ztab1 AS t1 WHERE t1~ \\_assoc1-key1 = 5 INTO TABLE @r.`, rel: Release.v740sp05},
  {abap: `SELECT count(*) AS cnt FROM ztab1 AS t1 WHERE x = 1 GROUP BY t1~ \\_assoc1-key1 INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT \\_assoc1 [ key1 < 3 ]-col FROM ztab1 INTO TABLE @r.`, rel: Release.v751},
], "SELECT association path invalid spacing");

statementVersionOk([
  {abap: "SELECT * FROM @lt_fields AS fields INTO TABLE @DATA(result).", rel: Version.OpenABAP},
], "SELECT FROM internal table", Statements.Select);

const windowVersions = [
  {abap: `SELECT company, category, item, price, row_number( ) over( ) AS rn FROM @ztable AS t ORDER BY rn INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT company, category, item, price, rank( ) over( order by price descending ) AS rnk FROM @ztable AS t ORDER BY rnk, company, category, item INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT company, category, item, price, dense_rank( ) over( order by price descending ) AS dr FROM @ztable AS t ORDER BY dr, company, category, item INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, row_number( ) over( order by field1, field2, field3 ) AS rn FROM @ztable AS t ORDER BY field3, field2, field1 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, row_number( ) over( partition by field1 order by field4, field3 ) AS rn FROM @ztable AS t ORDER BY field3, field2, field1 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, row_number( ) over( partition by field2, field1 order by field4, field3 ) AS rn FROM @ztable AS t ORDER BY field3, field2, field1 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, rank( ) over( partition by field1 order by field4 descending ) AS rnk FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, rank( ) over( partition by field2, field1 order by field4 descending ) AS rnk FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, dense_rank( ) over( partition by field2, field1 order by field4 descending ) AS dr FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, count(*) over( ) AS cnt FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, count(*) over( partition by field1 ) AS cnt FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, count(*) over( partition by field1, field2 ) AS cnt FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, count(*) over( partition by field1, field2 order by field4 ) AS cnt FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, sum( field4 ) over( ) AS s FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, sum( field4 ) over( partition by field1, field2 ) AS s FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, sum( field4 ) over( partition by field1, field2 order by field4 ) AS s FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, min( field4 ) over( ) AS m FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, min( field4 ) over( partition by field1, field2 ) AS m FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, min( field4 ) over( partition by field1, field2 order by field3 ) AS m FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, max( field4 ) over( ) AS m FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, max( field4 ) over( partition by field1, field2 ) AS m FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, max( field4 ) over( partition by field1, field2 order by field3 ) AS m FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT AVG( field1 AS DEC( 15, 2 ) ) AS a FROM ztable INTO @DATA(result).`, rel: Release.v751},
  {abap: `SELECT AVG( field1 AS CURR( 15, 2 ) ) AS a FROM ztable INTO @DATA(result).`, rel: Release.v751},
  {abap: `SELECT AVG( field1 AS QUAN( 15, 2 ) ) AS a FROM ztable INTO @DATA(result).`, rel: Release.v751},
  {abap: `SELECT AVG( field1 AS D16N ) AS a FROM ztable INTO @DATA(result).`, rel: Release.v751},
  {abap: `SELECT AVG( field1 AS D34N ) AS a FROM ztable INTO @DATA(result).`, rel: Release.v751},
  {abap: `SELECT AVG( field1 AS FLTP ) AS a FROM ztable INTO @DATA(result).`, rel: Release.v751},
  {abap: `SELECT AVG( DISTINCT field1 AS DEC( 10, 3 ) ) AS a FROM ztable INTO @DATA(result).`, rel: Release.v751},
  {abap: `SELECT field1, field2, field3, field4, avg( field4 as dec( 31, 2 ) ) over( ) AS a FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, avg( field4 as dec( 31, 2 ) ) over( partition by field1, field2 ) AS a FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, avg( field4 as dec( 31, 2 ) ) over( partition by field1, field2 order by field3 ) AS a FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, avg( field4 as curr( 15, 2 ) ) over( ) AS a FROM @ztable AS t ORDER BY field1 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, avg( field4 as quan( 15, 2 ) ) over( ) AS a FROM @ztable AS t ORDER BY field1 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, avg( field4 as d16n ) over( ) AS a FROM @ztable AS t ORDER BY field1 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, avg( field4 as d34n ) over( ) AS a FROM @ztable AS t ORDER BY field1 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, avg( field4 as fltp ) over( ) AS a FROM @ztable AS t ORDER BY field1 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, case when avg( field4 ) over( ) > @lv_val then 1 else 0 end AS flag FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, count( field4 ) over( ) AS cnt FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, count( field4 ) over( partition by field1 ) AS cnt FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, field3, field4, count( field4 ) over( partition by field1, field2 ) AS cnt FROM @ztable AS t ORDER BY field1, field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, sum( field4 ) AS s1, sum( sum( field4 ) ) over( partition by field1 ) AS s2 FROM @ztable AS t GROUP BY field1, field2 ORDER BY field1, field2 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT field1, field2, division( sum( field4 ), sum( sum( field4 ) ) over( partition by field1 ), 2 ) AS d FROM @ztable AS t GROUP BY field1, field2 ORDER BY field1, field2 INTO TABLE @DATA(result).`, rel: Release.v757},
];

statementVersionOk(windowVersions, "SELECT", Statements.Select);

const frameVersions = [
  {abap: `SELECT FROM ztable FIELDS sum( field1 ) over( partition by field2 order by field3 rows between unbounded preceding and unbounded following ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS sum( field1 ) over( partition by field2 order by field3 rows between unbounded preceding and 2 following ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS sum( field1 ) over( partition by field2 order by field3 rows between unbounded preceding and 1 following ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS sum( field1 ) over( partition by field2 order by field3 rows between unbounded preceding and 0 following ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS sum( field1 ) over( partition by field2 order by field3 rows between unbounded preceding and current row ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS coalesce( sum( field1 ) over( partition by field2 order by field3 rows between 1 following and 2 following ), 1728 ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS coalesce( sum( field1 ) over( partition by field2 order by field3 rows between 1 preceding and 2 following ), 1728 ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS coalesce( sum( field1 ) over( partition by field2 order by field3 rows between 2 preceding and 1 preceding ), 1728 ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS coalesce( sum( field1 ) over( partition by field2 order by field3 rows between 2 preceding and unbounded following ), 1728 ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS coalesce( sum( field1 ) over( partition by field2 order by field3 rows between current row and unbounded following ), 1728 ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS coalesce( sum( field1 ) over( partition by field2 order by field3 rows between 1 following and unbounded following ), 1728 ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS coalesce( avg( field1 as dec( 16, 2 ) ) over( partition by field2 order by field3 rows between 1 following and unbounded following ), 1728 ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
  {abap: `SELECT FROM ztable FIELDS coalesce( avg( field1 as d34n ) over( partition by field2 order by field3 rows between 1 following and unbounded following ), 1728 ) WHERE field4 = @lv_val ORDER BY field2, field3 INTO TABLE @DATA(result).`, rel: Release.v757},
];

statementVersionOk(frameVersions, "SELECT", Statements.Select);

const aggArgExprVersions = [
  {abap: `SELECT SINGLE SUM( field1 + field2 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE SUM( field1 - field2 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE SUM( field1 * field2 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE MIN( field1 + 1 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE MAX( field1 + field2 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE AVG( field1 + field2 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE COUNT( DISTINCT field1 + field2 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE SUM( field1 + @lv_offset ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE SUM( CASE WHEN field1 > 0 THEN field1 ELSE 0 END ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT SINGLE SUM( CASE WHEN field1 > 0 THEN field1 ELSE - field1 END ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: `SELECT - col AS neg , col FROM ztab INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
];

statementVersionOk(aggArgExprVersions, "SELECT", Statements.Select);

const aggInArithVersions = [
  {abap: `SELECT SINGLE 1 + SUM( field1 ) FROM ztable INTO @DATA(result).`, rel: Release.v754},
  {abap: `SELECT SINGLE SUM( field1 ) + SUM( field2 ) FROM ztable INTO @DATA(result).`, rel: Release.v754},
  {abap: `SELECT SINGLE SUM( field1 ) * 2 FROM ztable INTO @DATA(result).`, rel: Release.v754},
  {abap: `SELECT SINGLE CASE WHEN field1 > 0 THEN SUM( field1 ) ELSE 0 END FROM ztable INTO @DATA(result).`, rel: Release.v754},
];
...
const versionsFail = [
  ...
  FROM but000
  WHERE  but000~partner IN ( '1000' , '2000' , '3000' ).`, rel: Release.v702},
  // order by not possible for SELECT SINGLE
  {abap: `SELECT SINGLE *
  FROM vbak
  INTO @DATA(ls_vbak)
  ORDER BY vbeln.`, rel: Release.v750},
  // missing comma,
  {abap: `SELECT foo bar, moo
  FROM ztab INTO TABLE @DATA(tab)
  ORDER BY PRIMARY KEY.`, rel: Release.v750},
  {abap: `SELECT ( arbgb, text ) AS bar FROM t100 INTO TABLE @DATA(sdf).`, rel: Release.v750},
  {abap: `SELECT ( arbgb AS bar ) FROM t100 INTO TABLE @DATA(sdf).`, rel: Release.v750},
  {abap: `SELECT SINGLE SUM( field1 + field2 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp05},
  {abap: `SELECT SINGLE 1 + SUM( field1 ) FROM ztable INTO @DATA(result).`, rel: Release.v740sp08},
  {abap: "SELECT SUM( (l_field) ) INTO l_value FROM (l_table).", rel: Release.v702},
];
  ...
  WHERE a~mandt   EQ sy-mandt
    ...
    ( SELECT MAX( version ) FROM zmain_table CLIENT SPECIFIED
      WHERE mandt    EQ sy-mandt
        ...
        AND version  IN s_version ).`, rel: Release.v740sp08},
];
...
const privilegedVersions = [
  {abap: `SELECT * FROM ztab WITH PRIVILEGED ACCESS INTO TABLE @DATA(lt).`, rel: Release.v752},
  {abap: `SELECT SINGLE * FROM ztab WITH PRIVILEGED ACCESS INTO @DATA(ls).`, rel: Release.v752},
  {abap: `SELECT * FROM ztab INTO TABLE @DATA(lt) PRIVILEGED ACCESS.`, rel: Release.v758},
  {abap: `SELECT SINGLE * FROM ztab INTO @DATA(ls) PRIVILEGED ACCESS.`, rel: Release.v758},
];
...
const privilegedVersionsFail = [
  ...
  {abap: `SELECT * FROM ztab INTO TABLE @DATA(lt) PRIVILEGED ACCESS.`, rel: Release.v757},
];
...
const optionsVersionsFail = [
  {abap: `SELECT count(*) FROM ztab INTO @DATA(wa) OPTIONS USING ALL CLIENTS.`, rel: Release.v757},
];

statementVersionFail(optionsVersionsFail, "SELECT OPTIONS clause");

const intersectExceptVersions = [
  {abap: `SELECT zcol FROM ztab1 INTERSECT SELECT zcol FROM ztab2 INTO TABLE @DATA(res).`, rel: Release.v756},
  {abap: `SELECT zcol FROM ztab1 INTERSECT DISTINCT SELECT zcol FROM ztab2 INTO TABLE @DATA(res).`, rel: Release.v756},
  {abap: `SELECT zcol FROM ztab1 EXCEPT SELECT zcol FROM ztab2 INTO TABLE @DATA(res).`, rel: Release.v756},
  {abap: `SELECT zcol FROM ztab1 EXCEPT DISTINCT SELECT zcol FROM ztab2 INTO TABLE @DATA(res).`, rel: Release.v756},
];

statementVersion(intersectExceptVersions, "SELECT INTERSECT/EXCEPT", Statements.Select);

const intersectExceptVersionsFail = [
  {abap: `SELECT zcol FROM ztab1 INTERSECT SELECT zcol FROM ztab2 INTO TABLE @DATA(res).`, rel: Release.v755},
  {abap: `SELECT zcol FROM ztab1 EXCEPT SELECT zcol FROM ztab2 INTO TABLE @DATA(res).`, rel: Release.v755},
];

statementVersionFail(intersectExceptVersionsFail, "SELECT INTERSECT/EXCEPT");

const unionChainVersions = [
  {abap: `SELECT zcol FROM ztab UNION ALL SELECT zcol FROM ztab UNION SELECT zcol FROM ztab INTO TABLE @DATA(res).`, rel: Release.v750},
];

statementVersion(unionChainVersions, "SELECT UNION chains and parentheses", Statements.Select);

const unionChainVersionsFail = [
  {abap: `SELECT zcol FROM ztab UNION ALL SELECT zcol FROM ztab INTO TABLE @DATA(res).`, rel: Release.v740sp08},
];

statementVersionFail(unionChainVersionsFail, "SELECT UNION chains and parentheses");

const subselectSetOpLoopVersions = [
  {abap: `SELECT zcol FROM ztab WHERE EXISTS ( SELECT zcol FROM ztab UNION ( SELECT zcol FROM ztab UNION SELECT zcol FROM ztab GROUP BY zcol ) ) GROUP BY zcol INTO @wa.`, rel: Release.v750},
];
...
const subselectSetOpVersions = [
  {abap: `SELECT * FROM ztab WHERE zcol = ( ( SELECT zcol FROM ztab2 ) ) INTO TABLE @itab.`, rel: Release.v750},
  {abap: `SELECT * FROM ztab WHERE zcol = ( ( SELECT zcol FROM ztab2 ) UNION SELECT zcol FROM ztab2 ) INTO TABLE @itab.`, rel: Release.v750},
];
...
statementVersion([
  {abap: `SELECT * FROM ztab CLIENT SPECIFIED t~mandt INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT * FROM ztab CLIENT SPECIFIED t~mandt WHERE col = @lv_v INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT * FROM ztab INNER JOIN ztab2 ON ztab~k = ztab2~k CLIENT SPECIFIED ztab~mandt , ztab2~mandt INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
  {abap: `SELECT * FROM ('ztab') CLIENT SPECIFIED (lv_cl) INTO CORRESPONDING FIELDS OF TABLE @lt_r.`, rel: Release.v740sp05},
  {abap: `SELECT * FROM ztab CLIENT SPECIFIED (lv_cl) WHERE col = @lv_v INTO TABLE @DATA(lt_r).`, rel: Release.v740sp05},
], "SELECT CLIENT SPECIFIED with column list or dynamic", Statements.Select);

statementVersionFail([
  {abap: `SELECT * FROM ztab CLIENT SPECIFIED t~mandt INTO TABLE @DATA(lt_r).`, rel: Release.v740sp02},
  {abap: `SELECT * FROM ztab CLIENT SPECIFIED (lv_cl) INTO TABLE @DATA(lt_r).`, rel: Release.v740sp02},
...
statementVersion([
  {abap: `SELECT col FROM ztab ORDER BY col INTO @DATA(lv_r) UP TO 1 ROWS OFFSET 5.`, rel: Release.v751},
  {abap: `SELECT col FROM ztab ORDER BY (lv_dyn) INTO @DATA(lv_r) UP TO 1 ROWS OFFSET 5.`, rel: Release.v751},
  {abap: `SELECT col FROM ztab ORDER BY col INTO TABLE @DATA(lt_r) PACKAGE SIZE 17 UP TO 1 ROWS OFFSET 2.`, rel: Release.v751},
...
statementVersionOk([
  ...
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with SIBLINGS ORDER BY
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root SIBLINGS ORDER BY sort_key ASCENDING ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with DEPTH
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root DEPTH 3 ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with MULTIPLE PARENTS NOT ALLOWED
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root MULTIPLE PARENTS NOT ALLOWED ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with MULTIPLE PARENTS ALLOWED
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root MULTIPLE PARENTS ALLOWED ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with MULTIPLE PARENTS LEAVES ONLY
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root MULTIPLE PARENTS LEAVES ONLY ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with ORPHAN IGNORE
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root ORPHAN IGNORE ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with ORPHAN ERROR
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root ORPHAN ERROR ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with ORPHAN ROOT
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root ORPHAN ROOT ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with CYCLE BREAKUP
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root CYCLE BREAKUP ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with CYCLE ERROR
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root CYCLE ERROR ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with CACHE ON
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root CACHE ON ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with CACHE FORCE
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root CACHE FORCE ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with GENERATE SPANTREE
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root GENERATE SPANTREE ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator with PERIOD / VALID
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent PERIOD FROM valid_from TO valid_to VALID FROM @lv_from TO @lv_to START WHERE id = @lv_root ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY generator: complex WHERE condition
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root AND level = 0 ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY accessor: HIERARCHY_DESCENDANTS
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS( SOURCE ztab START WHERE id = @lv_root ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY accessor: HIERARCHY_ANCESTORS
  {abap: `SELECT * FROM HIERARCHY_ANCESTORS( SOURCE ztab START WHERE id = @lv_node ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY accessor: HIERARCHY_SIBLINGS
  {abap: `SELECT * FROM HIERARCHY_SIBLINGS( SOURCE ztab START WHERE id = @lv_node ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY accessor with DISTANCE FROM
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS( SOURCE ztab START WHERE id = @lv_root DISTANCE FROM 1 ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY accessor with DISTANCE TO
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS( SOURCE ztab START WHERE id = @lv_root DISTANCE TO 3 ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY accessor with DISTANCE FROM ... TO
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS( SOURCE ztab START WHERE id = @lv_root DISTANCE FROM 1 TO 3 ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY aggregate: HIERARCHY_DESCENDANTS_AGGREGATE with MEASURES
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS_AGGREGATE( SOURCE ztab START WHERE id = @lv_root MEASURES SUM( amount ) AS total ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY aggregate: HIERARCHY_ANCESTORS_AGGREGATE with MEASURES
  {abap: `SELECT * FROM HIERARCHY_ANCESTORS_AGGREGATE( SOURCE ztab START WHERE id = @lv_root MEASURES SUM( amount ) AS total ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY aggregate with multiple measures
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS_AGGREGATE( SOURCE ztab START WHERE id = @lv_root MEASURES SUM( amount ) AS total , COUNT( * ) AS cnt ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY aggregate with WHERE
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS_AGGREGATE( SOURCE ztab START WHERE id = @lv_root MEASURES SUM( amount ) AS total WHERE level > 0 ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY aggregate with WITH SUBTOTAL
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS_AGGREGATE( SOURCE ztab START WHERE id = @lv_root MEASURES SUM( amount ) AS total WITH SUBTOTAL ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY aggregate with JOIN
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS_AGGREGATE( SOURCE ztab START WHERE id = @lv_root JOIN zdata ON zdata~id = id MEASURES SUM( amount ) AS total ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
  // HIERARCHY aggregate without START WHERE (optional)
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS_AGGREGATE( SOURCE ztab MEASURES SUM( amount ) AS total ) AS h INTO TABLE @DATA(lt).`, rel: Release.v750},
], "SELECT hierarchy source functions", Statements.Select);

statementVersionOk([
  // SIBLINGS ORDER BY single field
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE col1 = 'X' SIBLINGS ORDER BY col2 ) INTO TABLE @DATA(result).`, rel: Release.v750},
  // LOAD INCREMENTAL
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root SIBLINGS ORDER BY col1 LOAD INCREMENTAL ) INTO TABLE @result.`, rel: Release.v750},
  // LOAD BULK
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root SIBLINGS ORDER BY col1 LOAD BULK ) INTO TABLE @result.`, rel: Release.v750},
  // LOAD @var
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _parent START WHERE id = @lv_root SIBLINGS ORDER BY col1 LOAD @load ) INTO TABLE @result.`, rel: Release.v750},
  // RETAIN NULLS @var (leveled)
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab LEVELS ( a, b, c ) RETAIN NULLS @n ) INTO TABLE @DATA(t).`, rel: Release.v750},
  // RETAIN NULLS with SIBLINGS ORDER BY before it
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab LEVELS ( a, b, c ) SIBLINGS ORDER BY a DESCENDING, b ASCENDING RETAIN NULLS @n ) INTO TABLE @DATA(t).`, rel: Release.v750},
...
statementVersionOk([
  ...
  {abap: `SELECT 1 FROM HIERARCHY( SOURCE ztab CHILD TO PARENT ASSOCIATION _self PERIOD FROM valid_from TO valid_to VALID FROM @timestamp TO @timestamp START WHERE 1 = 0 ) INTO @result.`, rel: Release.v750},
  // SOURCE with alias
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab AS foo CHILD TO PARENT ASSOCIATION _parent START WHERE foo~col1 = 'X' SIBLINGS ORDER BY foo~col3 ) INTO @result.`, rel: Release.v750},
  // SOURCE with alias + ORDER BY PRIMARY KEY
  {abap: `SELECT * FROM HIERARCHY( SOURCE ztab AS foo CHILD TO PARENT ASSOCIATION _parent START WHERE foo~col1 = 'X' SIBLINGS ORDER BY PRIMARY KEY ) INTO @result.`, rel: Release.v750},
  // aggregate: WITH SUBTOTAL
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS_AGGREGATE( SOURCE ztab MEASURES COUNT( * ) AS cnt WITH SUBTOTAL ) INTO @bar.`, rel: Release.v750},
  // aggregate: JOIN
  {abap: `SELECT * FROM HIERARCHY_DESCENDANTS_AGGREGATE( SOURCE ztab JOIN zdata ON ztab~id = zdata~fk MEASURES COUNT( * ) AS cnt ) INTO @wa.`, rel: Release.v750},
  // aggregate: WHERE
...
statementVersionOk([
  ...
  {abap: `SELECT OCCURRENCES_REGEXPR( '([[:digit:]])' FLAG @lv_flag IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( '([[:digit:]])' IN col1 FROM 5 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( '([[:digit:]])' FLAG @lv_flag IN col1 FROM @lv_start ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( col2 IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( '\p{Ll}+' IN 'hello world' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( @lv_pat IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( '.*' IN col1 WITH 'x' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( '.*' FLAG @lv_flag IN col1 WITH @lv_rep FROM 5 OCCURRENCE ALL ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( '.*' IN col1 WITH @lv_rep FROM @lv_start OCCURRENCE 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( '\p{Ll}+' IN col1 WITH 'a' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( 'A' IN col1 WITH 'q' OCCURRENCE 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( 'A' IN col1 WITH 'q' OCCURRENCE 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( '[A-Za-z]' IN col1 WITH 'b' FROM 2 OCCURRENCE 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT REPLACE_REGEXPR( ' ' IN 'a b' WITH 'x' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT SUBSTRING_REGEXPR( '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( '.*' FLAG @lv_flag IN col1 FROM 5 OCCURRENCE ALL GROUP @lv_grp ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( '.*' IN col1 OCCURRENCE 1 GROUP 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( col2 IN col1 GROUP 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( col2 IN col1 GROUP 0 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( col2 IN col1 OCCURRENCE @lv_occ GROUP 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( '(?<!b)a(.*)' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT SUBSTR_REGEXPR( '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT SUBSTR_REGEXPR( '.*' IN col1 OCCURRENCE 1 GROUP @lv_grp ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( START '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( AFTER '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( '.*' FLAG @lv_flag IN col1 FROM 5 OCCURRENCE ALL GROUP @lv_grp ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( START @lv_pat FLAG @lv_flag IN @lv_val FROM @lv_start OCCURRENCE @lv_occ GROUP @lv_grp ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( '(?i)HE.LO' IN col1 OCCURRENCE 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( '(?i)HE.LO' IN col1 GROUP 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( '(?i)HE.LO' IN col1 FROM 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( START '(?i)HE.LO' IN col1 OCCURRENCE 1 GROUP 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT LOCATE_REGEXPR( AFTER '(?i)HE.LO' FLAG @lv_flag IN col1 FROM @lv_start OCCURRENCE @lv_occ ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
], "SELECT regexpr functions", Statements.Select);

statementVersionOk([
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR 'then|this' INTO @lv_result.`, rel: Release.v757},
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR @lv_pat INTO @lv_result.`, rel: Release.v757},
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR 'x.*' FLAG @lv_flag INTO @lv_result.`, rel: Release.v757},
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR '(?<=a)a' INTO @lv_result.`, rel: Release.v757},
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR col2 INTO @lv_result.`, rel: Release.v757},
], "SELECT LIKE_REGEXPR predicate", Statements.SelectLoop);

statementVersionOk([
  {abap: `SELECT abs( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v740sp05},
  {abap: `SELECT ceil( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v740sp05},
  {abap: `SELECT floor( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v740sp05},
  {abap: `SELECT div( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v740sp05},
  {abap: `SELECT mod( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v740sp05},
  {abap: `SELECT coalesce( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v740sp05},
  {abap: `SELECT coalesce( col1, col2, col3 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v740sp05},
  {abap: `SELECT coalesce( col1, 0 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v740sp05},
  {abap: `SELECT concat( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT length( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT ltrim( col1, ' ' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT rtrim( col1, ' ' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT right( col1, 3 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT replace( col1, 'a', 'b' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT round( col1, 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT substring( col1, 1, 3 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT lpad( col1, 10, '0' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT instr( col1, 'x' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v750},
  {abap: `SELECT concat_with_space( col1, col2, 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v751},
  {abap: `SELECT rpad( col1, 10, '0' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v751},
  {abap: `SELECT left( col1, 3 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v751},
  {abap: `SELECT lower( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v751},
  {abap: `SELECT upper( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v751},
  {abap: `SELECT division( col1, col2, 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v751},
  {abap: `SELECT bintohex( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v752},
  {abap: `SELECT hextobin( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v752},
  {abap: `SELECT dats_is_valid( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v754},
  {abap: `SELECT dats_days_between( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v754},
  {abap: `SELECT dats_add_days( col1, 7 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v754},
  {abap: `SELECT dats_add_months( col1, 3 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v754},
  {abap: `SELECT uuid( ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v754},
  {abap: `SELECT utcl_current( ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v754},
  {abap: `SELECT tstmp_current_utctimestamp( ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_is_valid( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tims_is_valid( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT utcl_add_seconds( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT utcl_seconds_between( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT datn_days_between( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT datn_add_days( col1, 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT datn_add_months( col1, 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT as_geo_json( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT allow_precision_loss( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT to_clob( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT to_blob( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT col1, grouping( col1 ) FROM ztab GROUP BY col1 INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT extract_year( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT extract_month( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT extract_day( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT extract_hour( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT extract_minute( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT extract_second( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT days_between( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT add_days( col1, 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT add_months( col1, 1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT monthname( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT dayname( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT initcap( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT is_valid( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT weekday( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT locate( col1, 'x' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT locate( col1, 'x', 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT greatest( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT greatest( col1, col2, col3 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT least( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT hierarchy_composite_id( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT sin( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT cos( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT tan( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT asin( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT acos( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT atan( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT sinh( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT cosh( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT tanh( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT sqrt( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT power( col1, 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT exp( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT ln( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT log10( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT log( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT utctolocal( col1, 'CET' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT localtoutc( col1, 'CET' ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT is_masked( col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
], "SELECT positional SQL functions", Statements.Select);

statementVersionOk([
  {abap: `SELECT abap_user_timezone( ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_user_timezone( user = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_user_timezone( client = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_user_timezone( user = col1, client = col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_user_timezone( client = col2, user = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_user_timezone( on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_user_timezone( user = col1, client = col2, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_user_timezone( on_error = @lv_err, client = col2, user = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_system_timezone( ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_system_timezone( client = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_system_timezone( on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_system_timezone( client = col1, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT abap_system_timezone( on_error = @lv_err, client = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_tims_to_tstmp( date = col1, time = col2, tzone = col3 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_tims_to_tstmp( tzone = col3, date = col1, time = col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_tims_to_tstmp( date = col1, time = col2, tzone = col3, client = col4 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_tims_to_tstmp( date = col1, time = col2, tzone = col3, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_tims_to_tstmp( on_error = @lv_err, client = col4, tzone = col3, time = col2, date = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_add_seconds( tstmp = col1, seconds = col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_add_seconds( seconds = col2, tstmp = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_add_seconds( tstmp = col1, seconds = col2, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_seconds_between( tstmp1 = col1, tstmp2 = col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_seconds_between( tstmp2 = col2, tstmp1 = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_seconds_between( tstmp1 = col1, tstmp2 = col2, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_to_dats( tstmp = col1, tzone = col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_to_dats( tzone = col2, tstmp = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_to_dats( tstmp = col1, tzone = col2, client = col3, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_to_tims( tstmp = col1, tzone = col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_to_tims( tzone = col2, tstmp = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_to_dst( tstmp = col1, tzone = col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmp_to_dst( tzone = col2, tstmp = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmpl_to_utcl( tstmpl = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmpl_to_utcl( tstmpl = col1, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmpl_to_utcl( tstmpl = col1, on_initial = @lv_ini ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmpl_to_utcl( tstmpl = col1, on_error = @lv_err, on_initial = @lv_ini ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmpl_to_utcl( on_initial = @lv_ini, on_error = @lv_err, tstmpl = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmpl_from_utcl( utcl = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmpl_from_utcl( utcl = col1, on_null = @lv_null ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tstmpl_from_utcl( on_null = @lv_null, utcl = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_to_datn( dats = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_to_datn( dats = col1, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_to_datn( dats = col1, on_initial = @lv_ini ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_to_datn( dats = col1, on_error = @lv_err, on_initial = @lv_ini ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_to_datn( on_initial = @lv_ini, on_error = @lv_err, dats = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_from_datn( datn = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_from_datn( datn = col1, on_null = @lv_null ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT dats_from_datn( on_null = @lv_null, datn = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tims_to_timn( tims = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tims_to_timn( tims = col1, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tims_to_timn( on_error = @lv_err, tims = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tims_from_timn( timn = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tims_from_timn( timn = col1, on_null = @lv_null ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT tims_from_timn( on_null = @lv_null, timn = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT currency_conversion( amount = col1, source_currency = col2, target_currency = col3, exchange_rate_date = col4 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT currency_conversion( exchange_rate_date = col4, target_currency = col3, source_currency = col2, amount = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT currency_conversion( amount = col1, source_currency = col2, target_currency = col3, exchange_rate_date = col4, exchange_rate_type = col5 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT currency_conversion( amount = col1, source_currency = col2, target_currency = col3, exchange_rate_date = col4, client = @sy-mandt, round = @lv_rnd, decimal_shift = @lv_ds, decimal_shift_back = @lv_dsb, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT currency_conversion( on_error = @lv_err, decimal_shift_back = @lv_dsb, decimal_shift = @lv_ds, round = @lv_rnd, client = @sy-mandt, exchange_rate_date = col4, exchange_rate_type = col5, target_currency = col3, source_currency = col2, amount = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v757},
  {abap: `SELECT unit_conversion( quantity = col1, source_unit = col2, target_unit = col3 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT unit_conversion( target_unit = col3, source_unit = col2, quantity = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT unit_conversion( quantity = col1, source_unit = col2, target_unit = col3, client = col4 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT unit_conversion( quantity = col1, source_unit = col2, target_unit = col3, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT unit_conversion( on_error = @lv_err, client = col4, target_unit = col3, source_unit = col2, quantity = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT curr_to_decfloat_amount( curr = col1, cuky = col2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT curr_to_decfloat_amount( cuky = col2, curr = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT ipow( base = col1, exp = 2 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT ipow( exp = 2, base = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
  {abap: `SELECT lang_to_char( lang = col1 ) FROM ztab INTO TABLE @DATA(lt).`, rel: Release.v758},
], "SELECT named-parameter SQL functions", Statements.Select);

const clientSpecifiedFail = [
  {abap: `SELECT * FROM zfoobar CLIENT SPECIFIED INTO TABLE @DATA(lt).`, rel: Release.Newest, langVer: LanguageVersion.Cloud},
];
