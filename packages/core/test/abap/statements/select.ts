...
statementVersionOk([
  {abap: `SELECT OCCURRENCES_REGEXPR( '([[:digit:]])' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( '([[:digit:]])' FLAG @lv_flag IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( '([[:digit:]])' IN col1 FROM 5 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( '([[:digit:]])' FLAG @lv_flag IN col1 FROM @lv_start ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( col2 IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( '\p{Ll}+' IN 'hello world' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT OCCURRENCES_REGEXPR( @lv_pat IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( '.*' IN col1 WITH 'x' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( '.*' FLAG @lv_flag IN col1 WITH @lv_rep FROM 5 OCCURRENCE ALL ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( '.*' IN col1 WITH @lv_rep FROM @lv_start OCCURRENCE 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( '\p{Ll}+' IN col1 WITH 'a' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( 'A' IN col1 WITH 'q' OCCURRENCE 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( 'A' IN col1 WITH 'q' OCCURRENCE 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( '[A-Za-z]' IN col1 WITH 'b' FROM 2 OCCURRENCE 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT REPLACE_REGEXPR( ' ' IN 'a b' WITH 'x' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT SUBSTRING_REGEXPR( '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( '.*' FLAG @lv_flag IN col1 FROM 5 OCCURRENCE ALL GROUP @lv_grp ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( '.*' IN col1 OCCURRENCE 1 GROUP 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( col2 IN col1 GROUP 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( col2 IN col1 GROUP 0 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( col2 IN col1 OCCURRENCE @lv_occ GROUP 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT SUBSTRING_REGEXPR( '(?<!b)a(.*)' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT SUBSTR_REGEXPR( '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT SUBSTR_REGEXPR( '.*' IN col1 OCCURRENCE 1 GROUP @lv_grp ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( START '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( AFTER '.*' IN col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( '.*' FLAG @lv_flag IN col1 FROM 5 OCCURRENCE ALL GROUP @lv_grp ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( START @lv_pat FLAG @lv_flag IN @lv_val FROM @lv_start OCCURRENCE @lv_occ GROUP @lv_grp ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( '(?i)HE.LO' IN col1 OCCURRENCE 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( '(?i)HE.LO' IN col1 GROUP 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( '(?i)HE.LO' IN col1 FROM 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( START '(?i)HE.LO' IN col1 OCCURRENCE 1 GROUP 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT LOCATE_REGEXPR( AFTER '(?i)HE.LO' FLAG @lv_flag IN col1 FROM @lv_start OCCURRENCE @lv_occ ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
], "SELECT regexpr functions", Statements.Select);

statementVersionOk([
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR 'then|this' INTO @lv_result.`, ver: Version.v757},
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR @lv_pat INTO @lv_result.`, ver: Version.v757},
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR 'x.*' FLAG @lv_flag INTO @lv_result.`, ver: Version.v757},
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR '(?<=a)a' INTO @lv_result.`, ver: Version.v757},
  {abap: `SELECT col1 FROM ztab WHERE col1 LIKE_REGEXPR col2 INTO @lv_result.`, ver: Version.v757},
], "SELECT LIKE_REGEXPR predicate", Statements.SelectLoop);

statementVersionOk([
  {abap: `SELECT abs( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v740sp05},
  {abap: `SELECT ceil( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v740sp05},
  {abap: `SELECT floor( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v740sp05},
  {abap: `SELECT div( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v740sp05},
  {abap: `SELECT mod( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v740sp05},
  {abap: `SELECT coalesce( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v740sp05},
  {abap: `SELECT coalesce( col1, col2, col3 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v740sp05},
  {abap: `SELECT coalesce( col1, 0 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v740sp05},
  {abap: `SELECT concat( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT length( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT ltrim( col1, ' ' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT rtrim( col1, ' ' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT right( col1, 3 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT replace( col1, 'a', 'b' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT round( col1, 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT substring( col1, 1, 3 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT lpad( col1, 10, '0' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT instr( col1, 'x' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v750},
  {abap: `SELECT concat_with_space( col1, col2, 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v751},
  {abap: `SELECT rpad( col1, 10, '0' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v751},
  {abap: `SELECT left( col1, 3 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v751},
  {abap: `SELECT lower( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v751},
  {abap: `SELECT upper( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v751},
  {abap: `SELECT division( col1, col2, 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v751},
  {abap: `SELECT bintohex( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v752},
  {abap: `SELECT hextobin( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v752},
  {abap: `SELECT dats_is_valid( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v754},
  {abap: `SELECT dats_days_between( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v754},
  {abap: `SELECT dats_add_days( col1, 7 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v754},
  {abap: `SELECT dats_add_months( col1, 3 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v754},
  {abap: `SELECT uuid( ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v754},
  {abap: `SELECT utcl_current( ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v754},
  {abap: `SELECT tstmp_current_utctimestamp( ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_is_valid( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tims_is_valid( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT utcl_add_seconds( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT utcl_seconds_between( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT datn_days_between( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT datn_add_days( col1, 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT datn_add_months( col1, 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT as_geo_json( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT allow_precision_loss( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT to_clob( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT to_blob( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT col1, grouping( col1 ) FROM ztab GROUP BY col1 INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT extract_year( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT extract_month( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT extract_day( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT extract_hour( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT extract_minute( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT extract_second( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT days_between( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT add_days( col1, 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT add_months( col1, 1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT monthname( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT dayname( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT initcap( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT is_valid( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT weekday( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT locate( col1, 'x' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT locate( col1, 'x', 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT greatest( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT greatest( col1, col2, col3 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT least( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT hierarchy_composite_id( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT sin( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT cos( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT tan( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT asin( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT acos( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT atan( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT sinh( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT cosh( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT tanh( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT sqrt( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT power( col1, 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT exp( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT ln( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT log10( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT log( col1, col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT utctolocal( col1, 'CET' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT localtoutc( col1, 'CET' ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT is_masked( col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
], "SELECT positional SQL functions", Statements.Select);

statementVersionOk([
  {abap: `SELECT abap_user_timezone( ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_user_timezone( user = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_user_timezone( client = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_user_timezone( user = col1, client = col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_user_timezone( client = col2, user = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_user_timezone( on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_user_timezone( user = col1, client = col2, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_user_timezone( on_error = @lv_err, client = col2, user = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_system_timezone( ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_system_timezone( client = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_system_timezone( on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_system_timezone( client = col1, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT abap_system_timezone( on_error = @lv_err, client = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_tims_to_tstmp( date = col1, time = col2, tzone = col3 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_tims_to_tstmp( tzone = col3, date = col1, time = col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_tims_to_tstmp( date = col1, time = col2, tzone = col3, client = col4 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_tims_to_tstmp( date = col1, time = col2, tzone = col3, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_tims_to_tstmp( on_error = @lv_err, client = col4, tzone = col3, time = col2, date = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_add_seconds( tstmp = col1, seconds = col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_add_seconds( seconds = col2, tstmp = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_add_seconds( tstmp = col1, seconds = col2, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_seconds_between( tstmp1 = col1, tstmp2 = col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_seconds_between( tstmp2 = col2, tstmp1 = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_seconds_between( tstmp1 = col1, tstmp2 = col2, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_to_dats( tstmp = col1, tzone = col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_to_dats( tzone = col2, tstmp = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_to_dats( tstmp = col1, tzone = col2, client = col3, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_to_tims( tstmp = col1, tzone = col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_to_tims( tzone = col2, tstmp = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_to_dst( tstmp = col1, tzone = col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmp_to_dst( tzone = col2, tstmp = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmpl_to_utcl( tstmpl = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmpl_to_utcl( tstmpl = col1, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmpl_to_utcl( tstmpl = col1, on_initial = @lv_ini ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmpl_to_utcl( tstmpl = col1, on_error = @lv_err, on_initial = @lv_ini ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmpl_to_utcl( on_initial = @lv_ini, on_error = @lv_err, tstmpl = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmpl_from_utcl( utcl = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmpl_from_utcl( utcl = col1, on_null = @lv_null ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tstmpl_from_utcl( on_null = @lv_null, utcl = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_to_datn( dats = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_to_datn( dats = col1, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_to_datn( dats = col1, on_initial = @lv_ini ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_to_datn( dats = col1, on_error = @lv_err, on_initial = @lv_ini ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_to_datn( on_initial = @lv_ini, on_error = @lv_err, dats = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_from_datn( datn = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_from_datn( datn = col1, on_null = @lv_null ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT dats_from_datn( on_null = @lv_null, datn = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tims_to_timn( tims = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tims_to_timn( tims = col1, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tims_to_timn( on_error = @lv_err, tims = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tims_from_timn( timn = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tims_from_timn( timn = col1, on_null = @lv_null ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT tims_from_timn( on_null = @lv_null, timn = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT currency_conversion( amount = col1, source_currency = col2, target_currency = col3, exchange_rate_date = col4 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT currency_conversion( exchange_rate_date = col4, target_currency = col3, source_currency = col2, amount = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT currency_conversion( amount = col1, source_currency = col2, target_currency = col3, exchange_rate_date = col4, exchange_rate_type = col5 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT currency_conversion( amount = col1, source_currency = col2, target_currency = col3, exchange_rate_date = col4, client = @sy-mandt, round = @lv_rnd, decimal_shift = @lv_ds, decimal_shift_back = @lv_dsb, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT currency_conversion( on_error = @lv_err, decimal_shift_back = @lv_dsb, decimal_shift = @lv_ds, round = @lv_rnd, client = @sy-mandt, exchange_rate_date = col4, exchange_rate_type = col5, target_currency = col3, source_currency = col2, amount = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v757},
  {abap: `SELECT unit_conversion( quantity = col1, source_unit = col2, target_unit = col3 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT unit_conversion( target_unit = col3, source_unit = col2, quantity = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT unit_conversion( quantity = col1, source_unit = col2, target_unit = col3, client = col4 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT unit_conversion( quantity = col1, source_unit = col2, target_unit = col3, on_error = @lv_err ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT unit_conversion( on_error = @lv_err, client = col4, target_unit = col3, source_unit = col2, quantity = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT curr_to_decfloat_amount( curr = col1, cuky = col2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT curr_to_decfloat_amount( cuky = col2, curr = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT ipow( base = col1, exp = 2 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT ipow( exp = 2, base = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
  {abap: `SELECT lang_to_char( lang = col1 ) FROM ztab INTO TABLE @DATA(lt).`, ver: Version.v758},
