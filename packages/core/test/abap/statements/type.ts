...
//  `TYPES ttyp TYPE SORTED TABLE OF ty WITH UNIQUE KEY 2fieldname.`,
  `TYPES tt_many_keys TYPE SORTED TABLE OF ty_s
    WITH UNIQUE KEY k1 k2 k3 k4 k5
    WITH NON-UNIQUE SORTED KEY sk01 COMPONENTS f01
    WITH NON-UNIQUE SORTED KEY sk02 COMPONENTS f02
    WITH NON-UNIQUE SORTED KEY sk03 COMPONENTS f03
    WITH NON-UNIQUE SORTED KEY sk04 COMPONENTS f04
    WITH NON-UNIQUE SORTED KEY sk05 COMPONENTS f05
    WITH NON-UNIQUE SORTED KEY sk06 COMPONENTS f06
    WITH NON-UNIQUE SORTED KEY sk07 COMPONENTS f07
    WITH NON-UNIQUE SORTED KEY sk08 COMPONENTS f08
    WITH NON-UNIQUE SORTED KEY sk09 COMPONENTS f09
    WITH NON-UNIQUE SORTED KEY sk10 COMPONENTS f10
    WITH NON-UNIQUE SORTED KEY sk11 COMPONENTS f11
    WITH NON-UNIQUE SORTED KEY sk12 COMPONENTS f12
    WITH NON-UNIQUE SORTED KEY sk13 COMPONENTS f13
    WITH NON-UNIQUE SORTED KEY sk14 COMPONENTS f14
    WITH NON-UNIQUE SORTED KEY sk15 COMPONENTS f15
    WITH NON-UNIQUE SORTED KEY sk16 COMPONENTS f16.`,
];
