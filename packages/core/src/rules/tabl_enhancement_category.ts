...
export class TABLEnhancementCategory implements IRule {
  ...
  public getMetadata() {
    return {
      ...
      shortDescription: `Checks that tables do not have the enhancement category 'not classified'. You may use standard report RS_DDIC_CLASSIFICATION_FINAL for adjustment.`,
    };
  }
