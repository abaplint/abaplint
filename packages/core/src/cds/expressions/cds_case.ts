...
export class CDSCase extends Expression {
  public getRunnable(): IStatementRunnable {
    ...
    const simple = seq(altPrio(CDSFunction, name), plusPrio(seq("WHEN", value, "THEN", value)), "ELSE", value);
    const complex = seq(plusPrio(seq("WHEN", CDSCondition, "THEN", value)), optPrio(seq("ELSE", value)));
