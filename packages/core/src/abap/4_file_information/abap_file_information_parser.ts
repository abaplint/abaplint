...
export class ABAPFileInformationParser {
  ...
  public parse(structure: StructureNode | undefined): ParsedFileInformation {
    const result: ParsedFileInformation = {
      interfaces: [],
      classes: [],
      forms: [],
      implementations: [],
  ...
  private parseClassImplementations(structure: StructureNode): InfoClassImplementation[] {
    const implementations: InfoClassImplementation[] = [];
  ...
  private parseForms(structure: StructureNode): InfoFormDefinition[] {
    const forms: InfoFormDefinition[] = [];
  ...
  private parseInterfaces(structure: StructureNode): InfoInterfaceDefinition[] {
    const interfaces: InfoInterfaceDefinition[] = [];
  ...
  private parseClasses(structure: StructureNode): InfoClassDefinition[] {
    const classes: InfoClassDefinition[] = [];
