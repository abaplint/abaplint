import {seq, Expression, optPrio, altPrio, plusPrio, ver, starPrio, AlsoIn} from "../combi";
...
export class ValueBody extends Expression {
  public getRunnable(): IStatementRunnable {
    const strucOrTab = seq(optPrio(Let), optPrio(ValueBase), starPrio(For), plusPrio(altPrio(FieldAssignment, ValueBodyLine)));
