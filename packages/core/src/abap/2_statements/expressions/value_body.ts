import {seq, tok, Expression, optPrio, altPrio, plusPrio, ver, starPrio} from "../combi";
...
export class ValueBody extends Expression {
  public getRunnable(): IStatementRunnable {
    ...
    const strucOrTab = seq(optPrio(Let), optPrio(base), starPrio(For), plusPrio(altPrio(FieldAssignment, foo)));
