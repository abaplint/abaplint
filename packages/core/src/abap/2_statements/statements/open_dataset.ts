...
import {verNot, str, seq, alts, pers, opts} from "../combi";
...
export class OpenDataset implements IStatement {
  ...
  public getMatcher(): IStatementRunnable {
    ...
    const direction = seq("FOR", alts("OUTPUT", "INPUT", "UPDATE", "APPENDING"));
    const encoding = seq("ENCODING", alts("DEFAULT", "UTF-8", "NON-UNICODE"));
