...
import {verNot, str, seqs, opt, tok, alt, regex as reg, optPrio, altPrio} from "../combi";
...
export class Uline implements IStatement {
  ...
  public getMatcher(): IStatementRunnable {
    ...
    const ret = seqs("ULINE", optPrio(str("AT")), opt(alt(pos, pos1, dyn, field)), optPrio(str("NO-GAP")));
