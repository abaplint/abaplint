...
import {FSTarget, Target, Source, Dynamic, SimpleSource4, Dereference} from "../expressions";
...
export class InsertInternal implements IStatement {
  ...
  public getMatcher(): IStatementRunnable {
    ...
    const intoTable = seq("INTO TABLE", Target, opt(Dereference), opt(alt(ref, assigning)));
