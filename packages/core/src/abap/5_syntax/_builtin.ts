...
export class BuiltIn {
  ...
  public searchBuiltin(name: string | undefined): IMethodDefinition | undefined {
    ...
    ret.push({name: "CMAX", mandatory: {"val1": new StringType(), "val2": new StringType()}, optional: {"val3": new StringType(), "val4": new StringType(), "val5": new StringType(), "val6": new StringType(), "val7": new StringType(), "val9": new StringType(), "val9": new StringType()}, return: new StringType(), version: Version.v702});
    ret.push({name: "CMIN", mandatory: {"val1": new StringType(), "val2": new StringType()}, optional: {"val3": new StringType(), "val4": new StringType(), "val5": new StringType(), "val6": new StringType(), "val7": new StringType(), "val9": new StringType(), "val9": new StringType()}, return: new StringType(), version: Version.v702});
    ret.push({name: "CONCAT_LINES_OF", mandatory: {"table": new TableType()}, optional: {"sep": new StringType()}, return: new StringType(), version: Version.v702});
    ...
    ret.push({name: "LINE_EXISTS", mandatory: {"val": new TableType()}, return: new CharacterType(1), version: Version.v740sp02});
    ret.push({name: "LINE_INDEX", mandatory: {"val": new StringType()}, return: new IntegerType(), version: Version.v740sp02});
    ret.push({name: "LINES", mandatory: {"val": new TableType()}, return: new IntegerType()});
    ...
    ret.push({name: "NMAX", mandatory: {"val1": new StringType(), "val2": new StringType()}, optional: {"val3": new StringType(), "val4": new StringType(), "val5": new StringType(), "val6": new StringType(), "val7": new StringType(), "val9": new StringType(), "val9": new StringType()}, return: new IntegerType(), version: Version.v702});
    ret.push({name: "NMIN", mandatory: {"val1": new StringType(), "val2": new StringType()}, optional: {"val3": new StringType(), "val4": new StringType(), "val5": new StringType(), "val6": new StringType(), "val7": new StringType(), "val9": new StringType(), "val9": new StringType()}, return: new IntegerType(), version: Version.v702});
