...
function quickfix() {
  return `&nbsp;<a href="/quick_fix.html">${quickfixIcon}</a>`;
}
...
function experimental() {
  return `&nbsp;<a href="/experimental.html">${experimentalIcon}</a>`;
}
...
function upport() {
  return `&nbsp;<a href="/upport.html">${upportIcon}</a>`;
}
...
function downport() {
  return `&nbsp;<a href="/downport.html">${downportIcon}</a>`;
}
...
function whitespace() {
  return `&nbsp;<a href="/whitespace.html">${whitespaceIcon}</a>`;
}
...
function naming() {
  return `&nbsp;<a href="/naming.html">${namingIcon}</a>`;
}
...
function syntax() {
  return `&nbsp;<a href="/syntax.html">${syntaxIcon}</a>`;
}
...
function styleguide() {
  return `&nbsp;<a href="/styleguide.html">${styleguideIcon}</a>`;
}
